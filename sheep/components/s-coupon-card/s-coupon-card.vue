		...
		list: {
			...
			default () {
				return [{
						title: '已领取',
						value: '0',
						icon: '/static/img/shop/order/nouse_coupon.webp',
					...
					},
					{
						title: '已使用',
						value: '0',
						icon: '/static/img/shop/order/useend_coupon.webp',
						path: '/pages/coupon/list',
						type: 'used',
					},
					{
						title: '已失效',
						value: '0',
						icon: '/static/img/shop/order/out_coupon.webp',
						path: '/pages/coupon/list',
						type: 'expired',
					},
					{
					  title: '领券中心',
					  value: '0',
					  icon: '/static/img/shop/order/all_coupon.webp',
					  path: '/pages/coupon/list',
					  type: 'all',
					},
				];
